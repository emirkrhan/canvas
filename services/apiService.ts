...
export const polishText = async (
  ...
  try {
    const response = await fetch('https://graphic-abstract-api.vercel.app/api/polish', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
export const sendChatMessage = async (
  ...
  try {
    const response = await fetch('https://graphic-abstract-api.vercel.app/api/chat', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
export const extractArticleFromPdf = async (pdfFile: File): Promise<ExtractedData> => {
  try {
    ...
    const response = await fetch('https://graphic-abstract-api.vercel.app/api/pdf/extract', {
      method: 'POST',
      body: formData,
    });
